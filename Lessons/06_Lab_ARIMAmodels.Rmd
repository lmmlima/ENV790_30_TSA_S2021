...
decompose_flow <- decompose(ts_inflow_data[,"HP15"],"additive")
plot(decompose_flow)
...
HP15_dese <- seasadj(decompose_flow) 
plot(HP15_dese)

#Exercise 3: Compare ACFs for full series and deseason series
par(mfrow=c(1,2))
acf1 = Acf(ts_inflow_data[,"HP15"], lag.max = 40, plot = TRUE) 
acf2 = Acf(HP15_dese, lag.max = 40, plot = TRUE) 

#Exercise 4: Compare PACFs for full series and deseason series
par(mfrow=c(1,2))
acf1 = Pacf(ts_inflow_data[,"HP15"], lag.max = 40, plot = TRUE) 
acf2 = Pacf(HP15_dese, lag.max = 40, plot = TRUE) 
