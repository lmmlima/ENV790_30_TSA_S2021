...
### Comments on A8: final project or competition
  ...
  Deliverables: aside from presentation each group need to submit the knitted version of their Rmd file to Sakai under A8. no need to submit Rmd file, just the pdf.
