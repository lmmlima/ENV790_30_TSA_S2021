...
ggplot(BR_complete, aes(x=Date, y=Rainfall)) +geom_line(color= "blue") + geom_smooth(method="lm") 
ggplot(BR_complete, aes(x=Date, y=Temperature_C)) +geom_line(color= "blue") + geom_smooth(method="lm") 
...
ts_br <- ts(BR_complete[,(2:3)], frequency =12)  
...
rainfall_stl <- stl(ts_br[,1], s.window = "period") 
temp_stl <- stl(ts_br[,2], s.window = "period") 
plot(rainfall_stl)
plot(temp_stl)
