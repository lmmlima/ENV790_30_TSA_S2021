...
Based on the rsiduals the fixed model seems to have the most evenly distributed risduals. The risidual distribution is one indication of accuracy. However, my one concern is that risduals are almot all above 0 from 2004-2010 that makes me hesitant about this model
